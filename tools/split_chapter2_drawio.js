...
const inputPath = path.join(__dirname, "..", "docs", "chapter2_flowcharts.drawio");
const outputDir = path.join(__dirname, "..", "docs", "chapter2_drawio_pages");
...
diagramMatches.forEach((match, index) => {
  ...
  const fileName = `2.${index + 1}.drawio`;
