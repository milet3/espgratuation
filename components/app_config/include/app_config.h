...
// TFT LCD (ILI9341) — SPI 接口 (ESP32-S3 可用引脚)
#define TFT_SCLK GPIO_NUM_7
#define TFT_MOSI GPIO_NUM_15
#define TFT_MISO GPIO_NUM_16
#define TFT_CS GPIO_NUM_17
#define TFT_DC GPIO_NUM_18
#define TFT_RST GPIO_NUM_8
#define TFT_BLK GPIO_NUM_9

// 触摸屏 (XPT2046) — 与 TFT 共享 SPI 总线
#define TOUCH_CS GPIO_NUM_10
#define TOUCH_IRQ GPIO_NUM_11
#define TOUCH_SCLK GPIO_NUM_4  // 独立 SPI
#define TOUCH_MOSI GPIO_NUM_5  // 独立 SPI
#define TOUCH_MISO GPIO_NUM_6  // 独立 SPI

#define LED_GW001_RGB_PIN -1 //
#define LED_GW001_RGB_ON_RED 0
#define LED_GW001_RGB_ON_GREEN 0
#define LED_GW001_RGB_ON_BLUE 0

// LoRa MW1268 模块 (UART 接口)
#define LORA_UART_TX -1
#define LORA_UART_RX -1
#define LORA_MD0_PIN -1
...
#define CAT1_TX_PIN -1 // 对应原理图 IO18 (避开调试串口)
#define CAT1_RX_PIN -1 // 对应原理图 IO17 (避开调试串口)
#define CAT1_PORT \
  UART_NUM_0                            // 调试阶段：从 UART2 搬到 UART0（或在 WiFi 模式下不使用）
#define CAT1_POWER_STATE_PIN -1  //
...
// 土壤传感器 (UART 接口)
#define SOIL_TX_PIN -1
#define SOIL_RX_PIN -1
#define SOIL_UART_POWER_PIN -1
#define SOIL_UART_GND_PIN -1
...
#ifndef FUSE_OTA_TASK_TYPE
#define FUSE_OTA_TASK_TYPE 2
#endif
...
/* Node sensor data cache is valid after at least one parsed report frame. */
#define SUB_NODE_DATA_READY ((uint32_t)0x00000200)
